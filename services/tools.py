    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "days_on_market": {"type": "integer"},
                "vacancy_rate": {"type": "number", "description": "Rental vacancy rate as a percentage (from SQM Research)"},
                "stock_on_market": {"type": "integer", "description": "Total properties currently listed for sale (from SQM Research)"},
