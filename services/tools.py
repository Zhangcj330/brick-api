...
UI_TOOLS = [
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "kitchen_condition": {"type": "string", "description": "Kitchen condition: Excellent, Good, Fair, Poor"},
                "bathroom_condition": {"type": "string", "description": "Bathroom condition: Excellent, Good, Fair, Poor"},
                ...
                "land_slope": {"type": "string", "description": "Block slope: Flat, Gentle Slope, or Steep Slope"},
                "land_slope_note": {"type": "string", "description": "Short note on slope and drainage"},
                "noise_level": {"type": "string", "description": "Overall noise level: Low, Moderate, or High"},
                "noise_sources": {"type": "array", "items": {"type": "string"}, "description": "List of noise sources found (flight path, train, traffic etc.)"},
                "noise_note": {"type": "string", "description": "1-sentence noise summary"},
                "builder_name": {"type": "string", "description": "Builder or developer name if known"},
                "builder_quality": {"type": "string", "description": "Builder quality: Reputable, Unknown, or Poor track record"},
                "builder_note": {"type": "string", "description": "Short note on builder quality or history"},
                "property_history_flags": {"type": "array", "items": {"type": "string"}, "description": "List of known property history flags (flood zone, defects, easements etc.)"},
                "property_history_note": {"type": "string", "description": "1-sentence property history summary"},
                "needs_inspection": {"type": "boolean", "description": "Whether a pre-purchase building inspection is recommended"},
                "needs_pest_control": {"type": "boolean", "description": "Whether a pest inspection is recommended"},
                "due_diligence_note": {"type": "string", "description": "1-sentence due diligence recommendation"},
                "warnings": {
                    "type": "array",
                    "items": {"type": "string"},
