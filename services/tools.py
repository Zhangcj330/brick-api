...
_ALL_TOOLS = [
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "listing_url": {"type": "string", "description": "realestate.com.au listing URL for this property, e.g. https://www.realestate.com.au/property-house-nsw-suburb-12345678"},
                "domain_url": {"type": "string", "description": "domain.com.au listing URL for this property, e.g. https://www.domain.com.au/address-suburb-state-postcode-12345678"},
                "warnings": {
                    "type": "array",
                    "items": {"type": "string"},
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "short_term_outlook": {"type": "string", "description": "1-5 year growth outlook: Strong, Moderate, Weak, or Caution"},
                "short_term_reason": {"type": "string", "description": "One-sentence reason for short-term outlook"},
                "long_term_outlook": {"type": "string", "description": "6-15 year growth outlook: Strong, Moderate, Weak, or Caution"},
                ...
                "buyer_profile": {"type": "string", "description": "1-sentence description of who typically buys in this suburb e.g. 'Popular with young professionals and first-home buyers seeking inner-city lifestyle.'"},
    ...
    },
    {
        ...
        "description": "Display a risk assessment panel with flood, overlay, bushfire, contract, noise, and property-specific risks. Always pass the property address when showing risks for a specific listing.",
        "parameters": {
            "type": "object",
            "properties": {
                "address": {"type": "string", "description": "Full street address of the property being assessed"},
                "suburb": {"type": "string"},
                "state": {"type": "string"},
                "postcode": {"type": "string"},
                "risks": {
                ...
                "recommendation": {"type": "string", "description": "1-2 sentence summary recommendation"},
            },
            "required": ["risks"],
        },
    },
